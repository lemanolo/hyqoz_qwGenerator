...
%
dtypes([type_name(op17_op17,op17_op17::op17_op17),type_name(op1_op1,op1_op1::op1_op1),type_name(op4_op4,op4_op4::op4_op4)]). 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
outputFileName('output/SS_HQ7-member_unsafe_false_global_memoization_cf_cost.txt').
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
