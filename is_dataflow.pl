is_dataflow(Edges):-
       ...
       length(Retrievals,1) -> (true)%,nl,write('   IS DATAFLOW'))
                         ; findall([R1,R2],(sublist([R1,R2],Retrievals),
                                            ...
                                            ),RetrievalsWithSequentialPaths),
                                            %nl,write(' RetrievalsWithSequentialPaths: '),write(RetrievalsWithSequentialPaths),
                                            RetrievalsWithSequentialPaths=[]%,nl,write('   IS DATAFLOW')
       ).
